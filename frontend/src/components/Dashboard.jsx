      ...
      {activeTab === 'eda' && (
        ...
        <div className="chart-card">
            ...
            <ResponsiveContainer width="100%" height={360}>
              <BarChart data={radianzaHistogramResult.data} barCategoryGap={0} margin={{ top: 10, right: 20, left: 50, bottom: 40 }}>
                ...
                <XAxis 
                  ...
                  tick={{ fontSize: 12 }}
                  height={40}
                  label={{ value: METRICAS.find(m => m.value === selectedMetrica)?.label || selectedMetrica, position: 'insideBottom', offset: -5 }}
                />
